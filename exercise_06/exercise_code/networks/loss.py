...
class CrossEntropyFromLogits(Loss):
    ...
    def forward(self, y_out, y_truth, reduction='mean'):
        ...
        # Subtracting the maximum value found in each row from the y_out array.
        # This step helps to prevent potential numerical overflow when exponentiating large numbers. 
        # Subtracting the maximum value ensures that the largest value becomes 0, reducing the risk of exponentiating very large numbers.
